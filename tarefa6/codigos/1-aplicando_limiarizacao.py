...
imgCarta = cv2.imread('tarefa6/sources/carta_getulio.jpg', 0)
...
mapa1 = cv2.imread('tarefa6/sources/mapa1.jpg', 0)
mapa2 = cv2.imread('tarefa6/sources/mapa2.jpg', 0)
mapa3 = cv2.imread('tarefa6/sources/mapa3.jpg', 0)
